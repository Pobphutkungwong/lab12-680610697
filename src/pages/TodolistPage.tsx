  ...
  return (
    <div className="container-fluid min-vh-100">
      <div className="row h-100">
        ...
        <Sidebar username="Pobphut" type="admin"></Sidebar>
        ...
        <div className="col-10 p-0 d-flex flex-column min-vh-100">
          ...
          <main className="flex-grow-1 p-4">
            <div className="container">
              ...
              <TaskCard id="1" title="Read a book" description="Vite + React + Bootstrap + TS" isDone={false} />
              <TaskCard id="2" title="Write code" description="Finish project for class" isDone={false} />
              <TaskCard id="3" title="Deploy app" description="Push project to GitHub Pages" isDone={true} />
            </div>
          </main>

          {/* ── 5) Footer (รับ props year, fullName, studentId) ─────────────── */}
          <Footer year={2026} fullname="Pobphut Kungwong" studentId="680610697"></Footer>
        </div>
      </div>
    </div>
  );
